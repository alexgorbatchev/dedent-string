...
function processInlinePlaceholders(line: string, values: Record<string, string>): string {
  ...
  let match: RegExpExecArray | null = placeholderRegex.exec(processedLine);
 ...
 *
 * This function:
 * - Removes common leading whitespace using dedentString
 * - Replaces standalone placeholders (for example, {key}) with properly indented multiline values
